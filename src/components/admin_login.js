...
export default function AdminLogin() {
    ...
    useEffect(() => {
        const isLogged=localStorage.getItem('loggedInAdmin')||null
        if (isLogged) {
            navigate('/admin')
        }
    ...
    function handleLogin() {
        const storedUsers = JSON.parse(localStorage.getItem('admin_details')) || []
        ...
        <div className="user-wrapper">
            ...
            <div className="login-content">
                ...
                <div className="toRegister">
                    <Link to='/admin_register'>Do Not Have An Account ?</Link>
                </div>
